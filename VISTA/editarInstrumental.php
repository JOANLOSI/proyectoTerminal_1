...
if (isset($_GET['id'])) {
   ...
   // Crear una instancia de ModInstrumental pasando la conexión como argumento
   $modInstrumental = new ModInstrumental($conexion);

   // Obtener el producto por su ID
   $producto = $modInstrumental->getProductoPorId($idProducto);
...
?>
      ...
      <head>
         ...
         <title>Editar Instrumental Odontologico</title>
      </head>

      <body>
         <h1>Editar Producto</h1>
         <?php include_once 'header.php'; ?>
         <form action="../CONTROLADOR/procesaInstrumental.php" method="POST">
