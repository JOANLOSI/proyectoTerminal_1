...
if (isset($_GET['id'])) {
    ...
    $modOrtodoncia = new ModOrtodoncia($conexion);

    // Obtener el producto por su ID
    $producto = $modOrtodoncia->getProductoPorId($idProducto);
...
<head>
    ...
    <title>Editar Ortodoncia</title>
</head>

<body>
    <h1>EDITAR PRODUCTO DE ORTODONCIA</h1>
    <?php include_once 'header.php'; ?>
    <form action="../CONTROLADOR/procesaOrtodoncia.php" method="POST">
