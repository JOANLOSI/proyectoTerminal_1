...
if (isset($_GET['id'])) {
    ...
    // Crear una instancia de ModDiversos pasando la conexión como argumento
    $modDiversos = new ModDiversos($conexion);

    // Obtener el producto por su ID
    $producto = $modDiversos->getProductoPorId($idProducto);
...
<head>
    ...
    <title>Editar Producto Diversos</title>
</head>

<body>
    <h1>EDITAR PRODUCTOS DIVERSOS</h1>
    <?php include_once 'header.php'; ?>
    <form action="../CONTROLADOR/procesaDiversos.php" method="POST">
